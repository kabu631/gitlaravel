  ...
  <AppLayout>
    <div class="max-w-3xl mx-auto">
      <nav class="text-sm text-gray-500 mb-6 flex items-center gap-2">
        ...
        <Link :href="route('news.index')" class="hover:text-violet-600 dark:hover:text-violet-400">News</Link> /
      ...
      <div class="prose prose-gray prose-violet dark:prose-invert max-w-none" v-html="article.content"/>
