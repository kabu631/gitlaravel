  ...
  <StaticPageLayout current-page="services"
    ...
    <div class="max-w-4xl">
      ...
      <div class="text-center mb-12">
        <span class="inline-block bg-violet-600 text-white text-xs font-bold uppercase tracking-widest px-4 py-1.5 rounded-full mb-4">What We Do</span>
      ...
      <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-5 mb-12">
        <div v-for="svc in services" :key="svc.title"
             class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-6 hover:border-violet-400 dark:hover:border-violet-500 hover:-translate-y-1 transition-all duration-300">
      ...
      <!-- Optional extra body content from admin -->
      <div v-if="body"
           class="bg-white dark:bg-gray-900 rounded-2xl border border-gray-200 dark:border-gray-800 p-8 mb-12 prose dark:prose-invert prose-sm max-w-none
                  prose-headings:text-gray-900 dark:prose-headings:text-gray-100 prose-p:text-gray-600 dark:prose-p:text-gray-300 prose-li:text-gray-500 dark:prose-li:text-gray-400
                  prose-a:text-violet-600 dark:prose-a:text-violet-400 hover:prose-a:text-violet-500"
           v-html="body" />
      ...
      <div class="rounded-2xl overflow-hidden mb-4"
        ...
        <div class="p-10 text-center">
          <h2 class="text-3xl font-extrabold text-white mb-3">Ready to upgrade your tech?</h2>
          <p class="text-violet-200 mb-6 max-w-lg mx-auto">Join thousands of smart shoppers who trust Git Infosys for real-time reviews, competitive prices, and premium gadgets.</p>
          <div class="flex justify-center gap-3 flex-wrap">
            <Link :href="route('gadgets.index')"
                  class="px-8 py-3 rounded-xl bg-white text-violet-700 font-bold hover:bg-gray-100 transition">
              Shop Now →
            </Link>
